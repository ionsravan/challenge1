...
public class team1_bottomsheet extends BottomSheetDialogFragment {
    public int mCoins;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final String team1_img_chg_st = intent.getStringExtra("team1_img_url");
        ...
        bottom_team_name.setText(team1_name_st);
        Glide.with(getActivity()).load(team1_img_chg_st).into(bottom_team_img);
...
//on challenge clicked
       challenge_button.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               mdata.team1_challege_amount(chng_amnt);
               progressBar.setVisibility(View.VISIBLE);
                   ...
                   if (mCoins >= challenge_amount && challenge_amount >= 50) {
                       ...
                       data_doc.put("team", "team1");
                       data_doc.put("time", createdDate);
                       data_doc.put("final_amount", "0");


                       mfirestore.collection("matches").document(doc_id).collection("team1").document().set(data_doc).addOnCompleteListener(new OnCompleteListener<Void>() {
                           @Override
                       ...
                       mfirestore.collection("users").document(user_id).update("mCoins", remaining_amount_string).addOnCompleteListener(new OnCompleteListener<Void>() {
                           ...
                           public void onComplete(@NonNull Task<Void> task) {
                               ...
                               mcoins_payed.putExtra("team_name", team1_name_st);
                               mcoins_payed.putExtra("team_image", team1_img_chg_st);
    ...
    public  interface data{
        void team1_challege_amount(String amount);
    }
